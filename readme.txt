...
Tags: wp ppt import,wordpress insert ppt text to editor,wp presentation reader,wordpress slides importer page,wpasposepresentationimporter,wp aspose presentation import,aspos slide importer,slide reader aspose cloud,aspose cloud storage slides reader
Requires at least: 2.8
Tested up to: 3.8.1
Stable tag: 1.0
License: GPLv2 or later

Aspose Cloud Presentation Importer reads text from the Presentation file and insert it into the editor.
...
3. Upload the directory '/aspose-cloud-presentation-importer/' to the '/wp-content/plugins/' directory.
4. Activate the plugin through the 'Plugins' menu in WordPress.
5. Click on 'Aspose Cloud Presentation Importer' link under Settings menu to access the admin section.
...
2. Post Page with "Aspose Cloud Presentation Importer" button
3. Aspose Cloud Presentation Importer popup for selecting whether to read content from local file or aspose cloud file.
